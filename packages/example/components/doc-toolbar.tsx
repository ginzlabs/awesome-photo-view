...
import { toolbarImages } from './doc-components';
const penguins = '/photos/penguins.jpg';
...
export default function DocDemo() {
  const [images, setImages] = React.useState(toolbarImages);
          ...
          <>
            ...
            <svg
              ...
              onClick={() => {
                setImages((prev) => {
                  const result = [...prev];
                  result.splice(index, 1, penguins);
                  return result;
                });
              }}
